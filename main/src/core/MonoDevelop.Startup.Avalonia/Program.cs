		...
		Environment.GetCommandLineArgs ().SkipWhile (a => a.StartsWith ("--sln=", StringComparison.Ordinal))
			.FirstOrDefault (a =>
				a is "--about" or "--prefs" or "--addins" or "--find" or "--build" or "--run"
					...
					or "--bookmarks" or "--addref" or "--brace" or "--buildone" or "--mcaret" or "--fmt" or "--diff" or "--fold" or "--viewcmds" or "--bubbles" or "--compl" or "--tool" or "--ctxmenu" or "--filter" or "--props" or "--dirtyfiles"
